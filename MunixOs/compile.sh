...
CFLAGS="-g -ffreestanding -mno-sse -fno-stack-protector -fno-builtin -nostdlib -m32"
...
nasm -f elf32 -o tss_awake.o asm/tss_awake.asm
cd munx
gcc ${CFLAGS} -c *.c
cd ..
cd tasks
...
gcc ${CFLAGS} -c *.c
cd ..
gcc ${CFLAGS} -c -o tss.o src/tss.c
...
i386-elf-ld  -Tlinker.ld -g -o kernel.ELF drivers/*.o vfs/*.o usr/*.o tasks/*.o munx/*.o tss_awake.o tss.o threads/*.o keyboard/*.o handlers/*.o tar/*.o math/*.o memory/*.o multiboot/*.o paging/*.o handler.o fs/*.o init/*.o pci/*.o partitions/*.o disk/*.o buddy.o minim/*.o mbash/*.o shell.o timer.o ksysarena.o pic.o memory.o isr.o gdt_load.o gdt.o isr_stubs.o idt_load.o idt.o kernel.o start.o /usr/lib/gcc/i386-elf/15.1.0/libgcc.a -L../../libs -lcs2 -lmunixcc -lmlink -lminiasm #-lzynk
cd ../..
